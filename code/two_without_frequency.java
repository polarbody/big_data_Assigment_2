...
public class two_without_frequency extends Configured implements Tool {

	private static final Logger LOG = Logger
			.getLogger(two_without_frequency.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new two_without_frequency(), args);
		System.exit(res);
	}

	public int run(String[] args) throws Exception {

		Job job = Job.getInstance(getConf(), "two_without_frequency");
	...
	public static class Reduce extends
		...
		public void reduce(LongWritable key, Iterable<Text> values,
			...
			for (String word : wordswithcountL) {
				countedword.append(secondprefix);
				secondprefix = " ";
